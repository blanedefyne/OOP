...
public class PolynomialTest {
    ...
    public void simplePlus() {
        ...
        assertEquals(new Polynomial(new double[] {1, 7, 17, 2, 2}), p1.plus(p2));
    }
    ...
    public void simpleMinus() {
        ...
        assertEquals("-1.3x^6 - 11.0x^5 - 10.0x^4 + 20.3x^3 - 4.0x^2 - 3.0x + 12.0",
    ...
    public void takeDerivative() {
        ...
        assertEquals(new Polynomial(new double[] {76.8, -26, 0, 176, -2.5, -66, 35}), p1.differentiate(1));
    }

    @Test
    public void takePrettyBigDerivative() {
        Polynomial p1 = new Polynomial(new double[] {7.72, 0, -25, 7, 2, 2.2, -9.1, 8});
        assertEquals(new Polynomial(new double[] {0}), p1.differentiate(10));
    }

    @Test
    public void takeAnotherBigDerivative() {
        Polynomial p1 = new Polynomial(new double[] {7.72, 0, -25, 7, 2, 2.2, -9.1, 8});
        assertEquals(new Polynomial(new double[] {264, -6552, 20160}), p1.differentiate(5));
    }
    ...
    public void exampleFirstTest() {
        ...
        assertEquals("7.0x^3 + 6.0x^2 + 19.0x + 6.0", p1.plus(p2.differentiate(1)).toString());
    }
    ...
    public void simpleMultiply() {
        ...
        assertEquals(new Polynomial(new double[] {-15, 27, -222, 1066, -1822, 2410, -2621,
                                                  2764, 114, -621, 1284, 1552, -97, -99}), p1.times(p2));
    ...
    public void polynomialWithItselfTest() {
        ...
        assertEquals("8.0x^9 - 29.0x^8 + 576.0x^7 - 1611.0x^6 + 394.0x^4 - 3.0x^3 + 46.0x^2 - 9.0x + 20.0",
