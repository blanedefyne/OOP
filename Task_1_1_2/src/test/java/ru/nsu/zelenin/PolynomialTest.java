...
public class PolynomialTest {
    ...
    public void takeDerivative() {
        ...
        assertEquals(new Polynomial(new double[] {76.8, -26, 0, 176, -2.5, -66, 35}),
                                                  p1.differentiate(1));
    }
    ...
    public void simpleMultiply() {
        ...
        assertEquals(new Polynomial(new double[]
        {-15, 27, -222, 1066, -1822, 2410, -2621, 2764, 114, -621, 1284, 1552, -97, -99}),
        p1.times(p2));
    }
    ...
    public void polynomialWithItselfTest() {
        ...
        assertEquals(
        "8.0x^9 - 29.0x^8 + 576.0x^7 - 1611.0x^6 + 394.0x^4 - 3.0x^3 + 46.0x^2 - 9.0x + 20.0",
