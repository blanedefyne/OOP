...
public class PolynomialTest {
    ...
    public void takePrettyBigDerivative() {
        ...
        Assertions.assertEquals(new Polynomial(new double[]{0}), p1.differentiate(10));
    }

    @Test
    public void takeAnotherBigDerivative() {
        Polynomial p1 = new Polynomial(new double[]{7.72, 0, -25, 7, 2, 2.2, -9.1, 8});
        Assertions.assertEquals(new Polynomial(new double[]{264, -6552, 20160}), p1.differentiate(5));
    }
    ...
    public void exampleFirstTest() {
        ...
        Assertions.assertEquals("7.0x^3 + 6.0x^2 + 19.0x + 6.0", p1.plus(p2.differentiate(1)).toString());
    }
